...
@synthesize viewForState,subtitles,titles,isObserving,showsDateLabel,wasTriggeredByUser,originalTopInset;
...
- (void)setTitle:(NSString *)title forState:(SVPullToRefreshState)state {
    ...
    if(state == SVPullToRefreshStateAll)
        [self.titles replaceObjectsInRange:NSMakeRange(0, 3) withObjectsFromArray:[NSArray arrayWithObjects:title, title, title,nil]];
    else
...
- (void)setSubtitle:(NSString *)subtitle forState:(SVPullToRefreshState)state {
    ...
    if(state == SVPullToRefreshStateAll)
        [self.subtitles replaceObjectsInRange:NSMakeRange(0, 3) withObjectsFromArray:[NSArray arrayWithObjects:subtitle, subtitle, subtitle,nil]];
    else
...
- (void)setCustomView:(UIView *)view forState:(SVPullToRefreshState)state {
    ...
    if(state == SVPullToRefreshStateAll)
        [self.viewForState replaceObjectsInRange:NSMakeRange(0, 3) withObjectsFromArray:[NSArray arrayWithObjects: viewPlaceholder, viewPlaceholder, viewPlaceholder,nil]];
    else
