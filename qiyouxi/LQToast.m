...
- (id) init {
	...
	if (self != nil) {
        ...
        _statusView.intervalTime = DEFAULT_INTERVAL;
...
- (void)show:(NSString*)text length:(NSTimeInterval)length inView:(UIView*)applicationView{
    ...
    NSMutableArray* array = [NSMutableArray arrayWithObject:text];
    _statusView.msgArray = array;
    _statusView.eachTime = (int)length;
...
//    notifierView.timeOnScreen = length;
//    [notifierView showInWindow:applicationView.window];
//
